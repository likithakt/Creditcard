...
public String getPath() {
 ...
 //System.out.println("the reverse path"+res.reverse().toString());
...
public static void start_transaction(String transamt) {
 String[] state = { "Groceries", "Electronic","Miscellaneous" };
 System.out.println("the state names are :"+Arrays.toString(state));
 double[][] aprob = { { 0.60, 0.40,0.20 },
                      { 0.30, 0.30,0.40 }, 
                      { 0.50, 0.30,0.20 }};
 String esym = "123";
 double[][] eprob = { { 1.0/3, 1.0/3, 1.0/3 },
                      { 0.20,  0.30,  0.50  },
                      { 0.30,  0.50,  0.20  }};
